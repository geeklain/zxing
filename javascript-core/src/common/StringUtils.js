...
export default class StringUtils {
  ...
  static guessEncoding(bytes, hints) {
    if (hints) {
      const characterSet = hints[DecodeHintType.CHARACTER_SET];
      if (characterSet) {
        return characterSet;
      }
    }
...
// TODO Normalize?
StringUtils.PLATFORM_DEFAULT_ENCODING = document && document.characterSet || 'UTF-8';
StringUtils.SHIFT_JIS = 'SJIS';
StringUtils.GB2312 = 'GB2312';
StringUtils.EUC_JP = 'EUC-JP';
StringUtils.UTF8 = 'UTF-8';
StringUtils.ISO88591 = 'ISO8859-1';
StringUtils.ASSUME_SHIFT_JIS =
  StringUtils.SHIFT_JIS.toLowerCase() === StringUtils.PLATFORM_DEFAULT_ENCODING.toLowerCase()
  || StringUtils.EUC_JP.toLowerCase() === StringUtils.PLATFORM_DEFAULT_ENCODING.toLowerCase();
