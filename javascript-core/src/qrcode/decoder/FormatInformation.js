...
export default class FormatInformation {
  ...
  static decodeFormatInformation(maskedFormatInfo1, maskedFormatInfo2) {
    ...
    // first
    return FormatInformation.doDecodeFormatInformation(maskedFormatInfo1 ^ FORMAT_INFO_MASK_QR,
  ...
  static doDecodeFormatInformation(maskedFormatInfo1, maskedFormatInfo2) {
    ...
    let exactMatch;
    FORMAT_INFO_DECODE_LOOKUP.some(function (decodeInfo) {
      const targetInfo = decodeInfo[0];
      if (targetInfo === maskedFormatInfo1 || targetInfo === maskedFormatInfo2) {
        // Found an exact match
        exactMatch = new FormatInformation(decodeInfo[1]);
        return true;
      }
  ...
  equals(other) {
    if (!(other instanceof FormatInformation)) {
      return false;
    }
